...
router.get('/classes/:id' , TrainerMiddleware,AdminMiddelware ,ClassesG)
router.get('/classes/leanth/:id' , TrainerMiddleware,AdminMiddelware,leadth_classes)
router.get('/classes' ,TrainerMiddleware,ClientMiddelware, AllClasses)
